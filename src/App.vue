...
<template>
 <section class="container mx-auto flex items-center flex-col">
        ...
        <div class="w-1/3 bg-gray-200 p-10 flex items-center flex-col space-y-10">
            ...
            <h2 class="text-2xl" v-if="weather=='t'">Weather: thunderstrom</h2>
            <h2 class="text-2xl" v-else-if="weather=='pc'">Weather: Partly Cloudy</h2>
            <h2 class="text-2xl" v-else-if="weather=='s'">Weather: Sunny</h2>
            ...
            <img v-else-if="weather=='t'" src="https://creazilla-store.fra1.digitaloceanspaces.com/icons/7912589/weather-icon-md.png" alt="">
        </div>
    </section>
</template>
